export var WaveType;
(function (WaveType) {
    WaveType[WaveType["DELTA"] = 2] = "DELTA";
    WaveType[WaveType["THETA"] = 6] = "THETA";
    WaveType[WaveType["ALPHA"] = 10] = "ALPHA";
    WaveType[WaveType["BETA"] = 20] = "BETA";
    WaveType[WaveType["GAMMA"] = 40] = "GAMMA";
    WaveType[WaveType["ZETA"] = 60] = "ZETA";
})(WaveType || (WaveType = {}));
export class OPE {
    alpha = 1 / Math.pow(Math.PI, 3);
    ternaryMode = false;
    // Periodic Cubic Activation (Standard OPE)
    activate(energy, omega) {
        const x = energy / 255;
