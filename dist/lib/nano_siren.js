...
export class NanoSIREN {
    ...
    constructor() {
        ...
        for (let i = 0; i < this.w1.length; i++)
            this.w1[i] = (ZMSFACore.formalRandom(seed + i + 1) - 0.5) * 2;
        for (let i = 0; i < this.b1.length; i++)
            this.b1[i] = (ZMSFACore.formalRandom(seed + i + 100) - 0.5) * 2;
        for (let i = 0; i < this.w2.length; i++)
            this.w2[i] = (ZMSFACore.formalRandom(seed + i + 200) - 0.5) * 2;
    }
    forward(x, y) {
